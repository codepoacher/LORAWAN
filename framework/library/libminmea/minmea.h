...
enum minmea_sentence_id {
    ...
    MINMEA_SENTENCE_ZDA,
    MINMEA_SENTENCE_TXT,
    MINMEA_SENTENCE_GPGSV,
    MINMEA_SENTENCE_BDGSV,
    MINMEA_SENTENCE_GNGSA,
    MINMEA_SENTENCE_GPGSA,
    MINMEA_SENTENCE_BDGSA,
};
...
struct minmea_sentence_rmc {
    ...
    bool valid;
    struct minmea_float latitude; char latitude_direction;
    struct minmea_float longitude; char longitude_direction;
...
struct minmea_sentence_gsv {
    ...
    int msg_nr;
    int total_sats;
    struct minmea_sat_info sats[GNNS_MAX_STAS];
};
...
static inline float minmea_tocoord(struct minmea_float *f)
{
    ...
    return (float) degrees + (float) minutes / ((float)60 * (float)f->scale);
}
